...
<div class="container-fluid">
  ...
  <?php if (!isset($_GET['add']) && !$editData) { ?>
    <div class="mb-3">
      <a href="?add=true" class="btn btn-primary">Add New Customer</a>
    </div>
  <?php } ?>

  <!-- 2. THE FORM (Opens if 'add' is clicked OR if 'edit' is clicked) -->
  <?php if (isset($_GET['add']) || $editData) { ?>
    <div class="card">
      <div class="card-body">
        <div class="row">
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-warning" href="?edit=<?php echo $row['customer_id']; ?>">Edit</a>
